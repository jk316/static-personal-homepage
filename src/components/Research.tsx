...
export default function Research() {
  const researchAreas = [
    ...
    },
    {
      ...
      icon: '/images/icon-streaming.svg',
    },
  ]
            ...
            <div key={index} className="flex gap-4">
              ...
              <div className="flex-shrink-0">
                <Image
                  ...
                  width={130}
                  height={130}
                  className="transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-xl cursor-pointer"
                />
              </div>
